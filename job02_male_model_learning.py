...
model = Sequential()
model.add(Conv2D(32, kernel_size=(8, 8), input_shape=(64, 64, 3), padding='same', activation='relu'))
...
fit_his=model.fit(X_train, Y_train, batch_size=16, epochs=15, validation_split=0.1,callbacks=[early_stopping])
score=model.evaluate(X_test, Y_test)
print('Evaluation loss:', score[0])
print('Evaluation accuracy:', score[1])
# model.save('./models/male_fashion_size_{}_acc_{}.h5'.format(size,str(np.around(score[1],2))[-2:]))
